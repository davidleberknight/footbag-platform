...
| Deployment, operations, infrastructure, CI/CD                                                                | DEVOPS_GUIDE.md and AWS_OPERATIONS.md (private GitHub repo, hard-required for AWS work rather than "when wired"); `docs/DEV_ONBOARDING.md` for new dev setup |
