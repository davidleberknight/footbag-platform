...
export const CANONICAL_PERSONAS: PersonaSpec[] = [
  ...
  // ── Club roles (authorization) ────────────────────────────────────────────
  {
    ...
    purpose: 'Confirmed live club leader (bootstrap claim promoted to a club_leaders row): the allow case for club-content edits.',
    onboardingComplete: true,
    club: { clubName: 'Downtown Footbag', leader: true, role: 'leader' },
    coverageNotes: [
      'live club_leaders row, role=leader (plus bootstrap-leader + signal provenance)',
      'allow: edits its own club content; holds the sole-leader-only actions',
    ],
  },
  {
    slug: 'club_coleader',
    ...
    tier: 'tier1',
    dimension: 'Club roles (authorization)',
    purpose: 'Live club co-leader: edits club content, but cannot perform the sole-leader-only actions.',
    onboardingComplete: true,
    club: { clubName: 'Seaside Footbag', role: 'co-leader' },
    coverageNotes: [
      'live club_leaders row, role=co-leader',
      'allow content edit; deny sole-leader-only actions',
    ],
  },
  {
    slug: 'club_leader_b',
    ...
    tier: 'tier1',
    dimension: 'Club roles (authorization)',
    purpose: 'Adjacent-owner: leads a different club, so club-scoped routes must deny it on clubs it does not lead (BOLA).',
    negative: true,
    onboardingComplete: true,
    club: { clubName: 'Hilltop Footbag', role: 'leader' },
    coverageNotes: [
      'live club_leaders row, role=leader of a different club',
