...
export function insertMember(db: BetterSqlite3.Database, o: MemberOverrides = {}): string {
  ...
  db.prepare(`
    INSERT INTO members (
      ...
      is_admin, is_system, is_board, is_hof, hof_inducted_year, is_bap, bap_inducted_year, is_deceased, deceased_at,
      searchable,
  ...
  `).run(
    ...
    o.is_admin ?? 0, o.is_system ?? 0, o.is_board ?? 0, o.is_hof ?? 0, o.hof_inducted_year ?? null, o.is_bap ?? 0, o.bap_inducted_year ?? null, o.is_deceased ?? 0, o.deceased_at ?? null,
    o.searchable ?? 1,
