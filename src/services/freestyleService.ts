...
const SET_MODIFIER_FEEL_CARDS: readonly ModifierFeelCard[] = [
  ...
  },
  {
    ...
    name:        'Atomic',
    glyph:       null,
    feel:        'Atomic launches with a cross-body, double-dexterity character from a toe set.',
    intuition:   'A heavier launch primitive that packs extra cross-body dexterity in from the toe set.',
