...
const WORD_TOKEN_LABELS: Record<string, string> = {
  ...
  TORQUE:    'Torque, base trick family (4 ADD; quantum osis)',
  ...
  WEAVING:   'Weaving, ducking launch set (+1 ADD, carried by the duck its launch incorporates)',
  ...
  FURIOUS:  'Furious, set modifier (+2; two-dex set)',
