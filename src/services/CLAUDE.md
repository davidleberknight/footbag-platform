...
## Ownership
- The service layer owns MVFP page-use-case logic for the current functionality slice.
...
- Do not add a repository layer, mediator layer, or extra orchestrator layer for this slice.
