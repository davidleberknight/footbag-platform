...
export const PASSBACK_ADD_DISAGREEMENTS: readonly AddDisagreementRow[] = [
  ...
  { ifpaSlug: 'dada_curve',                ifpaName: 'dada curve',                ifpaFormula: null,                            passbackAdd: 2, curatorNote: 'IFPA canonical = 4 ADD (2 dexes + xbody + stall); an outside source counts 2 dexes' },
