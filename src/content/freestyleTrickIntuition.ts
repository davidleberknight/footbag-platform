...
export const TRICK_INTUITION_ENTRIES: readonly TrickIntuitionEntry[] = [
  ...
  },
  {
    ...
    attribution: 'Per an outside source (2-ADD canonical reference).',
  },
  {
    slug: 'whirl',
    prose:
    ...
    attribution: 'Per an outside source (3-ADD canonical reference).',
  },
  {
    slug: 'butterfly',
    prose:
  ...
  },
  {
    ...
    attribution: 'Per an outside source (5-ADD canonical reference).',
  },
  {
    slug: 'paradox-mirage',
    prose:
  ...
  },
  {
    ...
    attribution: 'Adapted from an outside source (airborne hop-over topology).',
  },
];
