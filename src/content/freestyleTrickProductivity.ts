...
export const TRICK_PRODUCTIVITY_ENTRIES: readonly TrickProductivity[] = [
...

  {
    ...
    productiveDescendants: [
      { slug: 'paradox_drifter', label: 'paradox-drifter', note: 'Paradox topology layered on the drifter chassis; 4 ADD.' },
      ...
      { slug: 'high_plains_drifter', label: 'high-plains-drifter', note: 'Sibling on the clipper-stall chassis with an additional modifier; 4 ADD.' },
    ],
  },

  {
    ...
    productiveDescendants: [
      { slug: 'paradox_barrage', label: 'paradox-barrage', note: 'Paradox layered on the doubled-dex chassis; 4 ADD.' },
...

  {
    ...
    productiveDescendants: [
      { slug: 'paradox_blender',          label: 'paradox-blender',          note: 'Paradox layered on the whirl-osis chassis; 5 ADD.' },
      { slug: 'fender',                   label: 'fender',                   note: 'Named extension on the blender chassis; 5 ADD.' },
      { slug: 'food_processor',           label: 'food-processor',           note: 'Blurry-modified blender; 6 ADD.' },
      { slug: 'spender',                  label: 'spender',                  note: 'Compound extension on the blender chassis; 6 ADD.' },
      { slug: 'mind_bender',              label: 'mind-bender',              note: 'Named extension on the blender chassis; 6 ADD.' },
      { slug: 'spinning_paradox_blender', label: 'spinning-paradox-blender', note: 'Spinning-paradox layered on blender; 6 ADD.' },
    ],
  },
...

  {
    ...
    productiveDescendants: [
      ...
      { slug: 'spinning_osis',  label: 'spinning-osis',  note: 'Rotational body modifier on osis; 4 ADD.' },
      { slug: 'aeon_flux',      label: 'aeon-flux',      note: '5-ADD named extension on the osis chassis.' },
    ],
  },

  {
    ...
    productiveDescendants: [
      ...
      { slug: 'atomic_butterfly',  label: 'atomic-butterfly',  note: 'Atomic modifier on butterfly; 4 ADD.' },
      { slug: 'ducking_butterfly', label: 'ducking-butterfly', note: 'Ducking body modifier on butterfly; 4 ADD.' },
...

  {
    ...
    productiveDescendants: [
      ...
      { slug: 'spinning_torque', label: 'spinning-torque', note: 'Rotational body modifier on torque; 5 ADD.' },
      { slug: 'atomic_torque',   label: 'atomic-torque',   note: 'Atomic modifier on torque; 6 ADD.' },
