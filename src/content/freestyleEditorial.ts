 ...
 *     editorial prose from a curated historical report derived from 774
 *     documented competitive events (1980–2026).
 *
 * Consumers:
...
export const HISTORY_ADD_SYSTEM: string[] = [
  ...
  'Modifiers are the body mechanics layered onto a base: rotations (spinning, blurry), dexterities (pixie, fairy), and positional constraints (ducking, symposium, paradox, atomic). Modifiers also interact with the base they attach to. The ADD system captures these gradations: a modifier that prepends an extra dexterity contributes +1, a two-dex set like barraging or furious contributes +2, and a compound set like nuclear contributes +2 by stacking paradox and illusion. Small details like this are what give the system its texture.',
