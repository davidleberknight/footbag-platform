...
export const CORE_ATOM_EDUCATIONAL: readonly CoreAtomEducationalCard[] = [
  ...
  },
  {
    ...
    displayName: 'Legover',
    adds:        '2',
    line:        "Formula: set + opposite-leg out-dex + catch on the dexing foot. The opposite leg swings out and over the bag, and the bag is caught on a toe stall on that same leg, the one that went over, not the foot that set.",
    relates:     "Legover is caught by the dexing foot, the leg that went over, which is what separates it and its partner pickup from mirage and illusion, which return to the setting foot. Legover is the out-dex of that dexing-foot-catch pair, pickup the in-dex. It is a workhorse base: the double-leg-over line builds on it.",
  ...
  },
  {
    ...
    displayName: 'Mirage',
    adds:        '2',
    line:        "Formula: set + opposite-leg in-dex + return to the setting toe. The opposite leg circles the bag from inside to outside and the bag drops back to the toe that set it, with the supporting hip dipping to sell the shape; the circling leg does not make the catch.",
    relates:     "Mirage's mirror is illusion: the same return to the setting toe reached by the opposite direction of travel. It is one of the most recognizable shapes in the sport and the root of a deep modifier family.",
  ...
  },
  {
    ...
    displayName: 'Pickup',
    adds:        '2',
    line:        "Formula: set + opposite-leg in-dex + catch on the dexing foot. The opposite leg scoops inward under the bag and picks it back up on a toe stall on that same leg, the one that scooped.",
    relates:     "Pickup is legover's dexing-foot-catch partner: both are caught by the leg that dexed, unlike mirage and illusion, which return to the setting foot. Pickup is the in-dex, legover the out-dex. It shares mirage's opposite-leg inside dex but is caught by the dexing foot instead of returning to the setting toe, which is what makes it a pickup and not a mirage.",
    reveal:      "Four toe atoms fall out of two independent switches: which way the dex travels, inside-to-outside or outside-to-inside, and which foot catches, the setting foot or the dexing foot (the leg that circled). Mirage is inside and returns to the setting foot; illusion is outside and returns to the setting foot; pickup is inside and is caught by the dexing foot; legover is outside and is caught by the dexing foot. Learn the grid rather than four separate moves, and each new toe compound names its parents by its direction and its catching foot.",
  },
  {
    slug:        'illusion',
    displayName: 'Illusion',
    adds:        '2',
    line:        "Formula: set + opposite-leg out-dex + return to the setting toe. The opposite leg sweeps out and across in a wide, leggy crescent and the bag returns to the toe that set it, a fuller and more extended motion than the mirage it reverses; the circling leg does not make the catch.",
    relates:     "Illusion is the reverse-direction mirage (out where mirage goes in), returning to the setting toe just as mirage does. It is not nearly identical to mirage: the reversed, leggier sweep makes the two clearly distinguishable by eye, and each grows its own line of compounds. The mirage/illusion pair is the clearest early case that direction is structural (the Mirror Law).",
