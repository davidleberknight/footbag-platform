...
export const GLOSSARY_TERMS: readonly GlossaryTerm[] = [
  ...
  },
  {
    ...
    moreHref: `${CONCEPTS}#section-surfaces`, moreLabel: 'Contact Surfaces & Delays',
  },
  {
    term: 'Set',
    slug: 'set',
  ...
  },
  {
    term: 'Stall',
    slug: 'stall',
    definition: 'Holding the bag still on a contact surface; also called a delay. Most stalls are 1 ADD, and a bare surface name (clipper, toe) defaults to its stall.',
    aliases: ['delay', 'DEL'],
    moreHref: `${CONCEPTS}#section-surfaces`, moreLabel: 'Contact Surfaces & Delays',
  },
  {
  ...
  },
  {
    term: 'Inside',
    slug: 'inside',
    definition: 'The inner side of the foot. Used in inside-stall delays and as a transitional contact in compounds that travel across the body.',
  ...
  },
  {
    term: 'Outside',
    slug: 'outside',
    definition: 'The outer side of the foot. Used in outside-stall delays; pairs with inside in same-foot transitions.',
  ...
  },
  {
    term: 'Flapper',
    slug: 'flapper',
    definition: 'A cross-body sole stall. The community name for the cross-body variant of a sole delay.',
    moreHref: `${CONCEPTS}#section-surfaces`, moreLabel: 'Contact Surfaces & Delays',
  },
  {
    term: 'Dragon',
  ...
  },
  {
    term: 'Toe set',
    slug: 'toe-set',
    definition: 'A set launched from a toe delay.',
  ...
  },
  {
    term: 'UNS',
    slug: 'uns',
    definition: 'The unusual-surface component in operational notation: a delay landing on a non-standard surface such as sole, knee, head, or cloud. It scores like any delay; the flag records that the surface is unusual.',
