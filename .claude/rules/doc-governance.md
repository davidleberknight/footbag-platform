...
- `docs/USER_STORIES.md`, `docs/DESIGN_DECISIONS.md`, `docs/SERVICE_CATALOG.md`, `PROJECT_SUMMARY_CONCISE.md`, `docs/VIEW_CATALOG.md`, `docs/DATA_MODEL.md`, `docs/TESTING.md` — pure design.
