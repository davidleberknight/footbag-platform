...
def seed_red_queue() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "evidence_links":      "NOTATION_STYLE_GUIDE §5.7; red_corrections_pt9.csv; red_corrections_pt10.csv",
            "proposed_resolution": "Keep SUMO (humans-first per §0); decomposition stays in description + editorial layer.",
            "red_status":          "accepted",
            "red_response":        "Red pt10 (2026-05-10) volunteers structural definition: 'Nuclear is a Paradox Atomic set'. Sumo (Nuclear Mirage) X-Dex escalation per pt9 preserved as the named exception. Notation form SUMO retained per §5.7.",
            "decision_date":       "2026-05-10",
            "notes":               "Closed by pt10 structural-definition + pt9 X-Dex.",
        },
        {
            "id":                  8,
            "topic":               "policy",
            "slug_affected":       "rotational_escalation",
            "claim":               "Rotational-escalation policy: do spinning/whirling/swirling modifiers get +2 (vs +1) when applied to rotational base tricks (whirl/torque/mirage/swirl)? Parser surfaced this as `rotational_escalation_policy_pending_red` warning since 2026-04.",
            "evidence_links":      "red-correction-pt10.txt; red_corrections_pt10.csv POLICY_RULE row",
            "proposed_resolution": "Retire escalation: spinning/whirling/swirling stay flat +1 on rotational bases. trick_modifiers.csv migration 2026-05-10: spinning add_bonus_rotational 2->1; swirling 2->1; whirling already 1,1. Parser warning retired.",
            "red_status":          "accepted",
            "red_response":        "Red pt10 example 'Spinning Symposium Whirl = Whirl(3) + Spinning(1) + Symposium(1) = 5' + James adjudication 'Whirl 3 ADD already includes the delay/stall component'. Final.",
            "decision_date":       "2026-05-10",
            "notes":               "Side-effect: 3 newly-exposed asserted-vs-computed divergences (see id 11).",
        },
        {
            "id":                  9,
            "topic":               "decomposition",
            "slug_affected":       "blur",
            "claim":               "Blur structural decomposition. candidate_core_families.yaml provisional reading_b 'quantum mirage' computed 3 ADD; asserted_adds=4. Either asserted is wrong or decomposition is incomplete.",
            "evidence_links":      "candidate_core_families.yaml; red_corrections_pt10.csv CANDIDATE_CORE row",
            "proposed_resolution": "Per James adjudication 2026-05-10: blur = Stepping Paradox Mirage (= +1+1+2 = 4 ADD). Supersedes the yaml's quantum-mirage reading_b. Data-side dictionary migration deferred to S5.",
            "red_status":          "accepted",
            "red_response":        "Red pt10 'b' to all candidate-cores; specific decomposition adjudicated by James as stepping+paradox+mirage.",
            "decision_date":       "2026-05-10",
            "notes":               "S5 demotion: remove blur from freestyle_tricks; add alias on mirage; lineage shifts.",
        },
        {
            "id":                  10,
            "topic":               "decomposition",
            "slug_affected":       "barfly",
            "claim":               "Barfly structural decomposition. candidate_core_families.yaml reading_b: '[infinity_compound]' placeholder; computed_adds: null. Decomposition formula was awaiting Red specification.",
            "evidence_links":      "candidate_core_families.yaml; red_corrections_pt10.csv CANDIDATE_CORE row",
            "proposed_resolution": "Per James adjudication 2026-05-10: barfly operational decomposition approved. Specific decomposition carries into /freestyle/moves planning artifacts and the workbook External Reconciliation evidence trail. Data-side dictionary migration deferred to S5.",
            "red_status":          "accepted",
            "red_response":        "Red pt10 'b'; James approved operational decomposition (specifics in planning/audit artifacts).",
            "decision_date":       "2026-05-10",
            "notes":               "S5 demotion: remove barfly from freestyle_tricks; add alias on infinity (or eventual core).",
        },
        {
            "id":                  11,
            "topic":               "add_dispute",
            "slug_affected":       "spinning-whirl,spinning-symposium-whirl,spinning-torque",
            "claim":               "Three spinning-rotational compounds now show asserted_adds vs computed_adds divergence after the pt10 modifier-value migration: spinning-whirl (asserted 5, computed 4); spinning-symposium-whirl (asserted 6, computed 5; matches pt10 example); spinning-torque (asserted 6, computed 5).",
            "evidence_links":      "parser_phase2_parses.json post-2026-05-10; red_corrections_pt10.csv POLICY_RULE row",
            "proposed_resolution": "Update asserted_adds to match the new computed values (spinning-whirl=4, spinning-symposium-whirl=5, spinning-torque=5). Pure data correction; needs a follow-up red_corrections_2026_04_20.csv append + loader 19 + Phase 4-style review pass.",
            "red_status":          "pending",
            "red_response":        "",
            "decision_date":       "",
            "notes":               "Direct consequence of pt10 policy change; no Red re-ask needed (data must follow the rule).",
        },
    ]
