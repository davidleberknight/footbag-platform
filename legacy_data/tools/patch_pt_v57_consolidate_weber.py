#!/usr/bin/env python3
"""
patch_pt_v57_consolidate_weber.py

Domain-expert identity consolidation: "Honza Weber" and "Jan Weber" are
the same person (Honza is the Czech nickname for Jan). Folds the standalone
Honza Weber PT row (0c03e968-f8b4-58fa-94d9-7c5094645d7a) into the
canonical Jan Weber row (1e09ba09-ec4b-5961-8b95-e0d638dc4f5c).

Same shape as patch_pt_v55 / v56. aliases_presentable left unchanged.

Usage (from legacy_data/):
    .venv/bin/python tools/patch_pt_v57_consolidate_weber.py
"""
...
PT_IN  = ROOT / "inputs" / "identity_lock" / "Persons_Truth_Final_v56.csv"
PT_OUT = ROOT / "inputs" / "identity_lock" / "Persons_Truth_Final_v57.csv"

DOOMED_PID   = "0c03e968-f8b4-58fa-94d9-7c5094645d7a"  # Honza Weber
SURVIVOR_PID = "1e09ba09-ec4b-5961-8b95-e0d638dc4f5c"  # Jan Weber

MERGE_NOTE = (
    "consolidated 0c03e968-f8b4-58fa-94d9-7c5094645d7a (Honza Weber) "
    "into 1e09ba09-ec4b-5961-8b95-e0d638dc4f5c per domain-expert 2026-04-23"
)
...
def main() -> None:
    ...
    print(f"v56 input rows: {len(rows)}")
    ...
    print(f"\nOutput: {PT_OUT}")
    print(f"  v56 rows: {len(rows)}  v57 rows: {len(out_rows)}  delta: -1")
