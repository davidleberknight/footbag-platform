#!/usr/bin/env python3
"""
patch_pt_v55_consolidate_peier.py

Domain-expert identity consolidation: "Andreas Grandi Peier" and
"Andreas Peier" are the same person. Folds the standalone Andreas Grandi
Peier PT row (0b36838e-ef53-5c81-adf5-5dda95b42e84) into the canonical
Andreas Peier row (1df65a5e-fdb5-5385-a31e-4ac28b916b28).

Same shape as patch_pt_v54_consolidate_lon_smith.py. aliases_presentable
left unchanged.

Usage (from legacy_data/):
    .venv/bin/python tools/patch_pt_v55_consolidate_peier.py
"""
...
PT_IN  = ROOT / "inputs" / "identity_lock" / "Persons_Truth_Final_v54.csv"
PT_OUT = ROOT / "inputs" / "identity_lock" / "Persons_Truth_Final_v55.csv"

DOOMED_PID   = "0b36838e-ef53-5c81-adf5-5dda95b42e84"  # Andreas Grandi Peier
SURVIVOR_PID = "1df65a5e-fdb5-5385-a31e-4ac28b916b28"  # Andreas Peier

MERGE_NOTE = (
    "consolidated 0b36838e-ef53-5c81-adf5-5dda95b42e84 (Andreas Grandi Peier) "
    "into 1df65a5e-fdb5-5385-a31e-4ac28b916b28 per domain-expert 2026-04-23"
)
...
def main() -> None:
    ...
    print(f"v54 input rows: {len(rows)}")
    ...
    print(f"\nOutput: {PT_OUT}")
    print(f"  v54 rows: {len(rows)}  v55 rows: {len(out_rows)}  delta: -1")
