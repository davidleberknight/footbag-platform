...
This suite needs Pillow. It runs two ways so that it works under any interpreter
carrying either dependency: under pytest it skips cleanly where Pillow is
absent; under a Pillow interpreter without pytest it runs its own checks via
__main__.
