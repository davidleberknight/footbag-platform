 ...
 * a `dev_admin_seed.*` reason code. That namespace belonged to the retired
 * direct-insert dev-admin seed and must not reappear in the canonical service.
 *
 * This test catches a copy-paste regression where someone inlines a
 * dev-admin-seed constant into the canonical service.
