 ...
 * /freestyle/concepts §composition (Symbolic Composition).
 *
...
describe('GET /freestyle/concepts — equivalence-topology coverage in §composition', () => {
...
describe('GET /freestyle/concepts — flurry worked example (preserved from prior subsection)', () => {
...
describe('GET /freestyle/concepts — witchdoctor worked example (preserved from prior subsection)', () => {
...
describe('GET /freestyle/concepts — curator-internal language never leaks', () => {
