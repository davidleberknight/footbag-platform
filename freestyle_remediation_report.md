...
**Still-open human inputs (tracked as tasks, not decisions for this report):** the Red Wave 3 doctrine answers (FS-23), the curator video viewings behind the same-side record names (FS-24), the Quantum-vs-Miraging ruling (FS-36), the IFPA Sick 3 rules wording (FS-33), and the demo poster/MP4 assets (FS-22). (The genuine-hyphen exception list was ruled and committed at FS-06's execution, and the terraging-rider question folded into the queue-wide delivery reset under FS-23.)
