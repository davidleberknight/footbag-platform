...
#   < ~/AWS/HOST_OPERATOR.txt bash scripts/restore-db.sh --target staging
#   < ~/AWS/HOST_OPERATOR_PRODUCTION.txt bash scripts/restore-db.sh --target production --snapshot routine/2026/08/21/footbag-20260821T055900Z.db.gz
...
#   < ~/AWS/HOST_OPERATOR_PRODUCTION.txt bash scripts/restore-db.sh --target production \
