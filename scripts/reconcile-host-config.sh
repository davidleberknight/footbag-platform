...
#
#   < ~/AWS/HOST_OPERATOR_PRODUCTION.txt bash scripts/reconcile-host-config.sh --target production --status
#   < ~/AWS/HOST_OPERATOR_PRODUCTION.txt bash scripts/reconcile-host-config.sh --target production --apply --reason "<why>"
