...
Quick status (reconciled to the clean-cutover reframe): **Settled**: 1, 8, 9, 12 (clean DNS cutover; SES outbound + Google inbound; legacy mail retires). **Moot under the clean cutover**: 19. **Confirmed against the delivered dump, re-confirm on the final export**: 10, 11, 17. **Still open (webmaster/Julie coordination)**: 2, 3, 4, 5, 6, 7, 13, 14, 15, 16, 18, 20, 21, 22, 23.
