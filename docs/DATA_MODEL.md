...
- **`media.*`**: `member_uploaded`, `curated_uploaded`, `member_edited`, `curated_edited`, `member_deleted`, `curated_deleted`, `curated_url_reference_added`, `curated_url_reference_edited`, `curated_url_reference_deleted`, `member_gallery_created`, `curated_gallery_created`, `member_gallery_updated`, `curated_gallery_updated`, `member_gallery_deleted`, `curated_gallery_deleted`, `flagged`, `deleted`, `flag_resolved`, `flag_cleared`.
