...
Both are purgeable: the comment is cleared on account erasure and on the deceased contact scrub, while the payment row itself is retained and anonymized past its compliance window, so the financial record survives the person leaving it.
