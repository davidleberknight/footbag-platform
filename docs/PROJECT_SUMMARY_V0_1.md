...
- **Tier 0:** Can log in, manage profile, search and view members/clubs, join one club, view and register for events, read news feed, access historical archive, and manage email subscriptions. Tier 0 is free and non-expiring, but is non-voting and not counted in the official IFPA roster.
