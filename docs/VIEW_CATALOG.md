...
- Freestyle section: landing wrapper (`.freestyle-landing`), hero with mascot (`.hero-with-mascot`, `.hero-mascot`), tile cards (`.card-tile`, `.format-card`), embedded video wrapper (`.video-embed`), stats strip (`.stats-strip`), trick-dictionary view toggle (`.trick-view-toggle`, `.trick-view-toggle-active`, `.trick-view-toggle-sep`), trick-dictionary coverage summary (`.trick-coverage-summary`, `.trick-coverage-counts`, `.trick-coverage-note`), trick-dictionary ADD-grouped layout (`.trick-add-group`, `.trick-list`, `.trick-row`, `.trick-row--external-placeholder`, `.trick-row-header`, `.trick-name`, `.trick-add-chip`, `.trick-add-chip--unrated`, `.trick-family-chip`, `.trick-category-chip`, `.trick-media-chip`, `.trick-media-chip--tutorial`, `.trick-media-chip--demo`, `.trick-media-chip--missing`, `.trick-media-chip--available` (legacy alias), `.trick-status-badge`, `.trick-notation`, `.trick-notation--missing`, `.trick-description`, `.trick-description--missing`, `.trick-aliases`, `.trick-placeholder-note`), trick-detail pathways cross-link block (`.trick-pathways`, `.trick-pathway-list`, `.trick-pathway`, `.trick-pathway--learn`, `.trick-pathway--watch`, `.trick-pathway--family`, `.trick-pathway--empty`, `.trick-pathway-title`, `.trick-pathway-primary`, `.trick-pathway-secondary`, `.trick-pathway-link`), trick-dictionary sets-grouped layout (`.trick-set-group`, `.trick-set-type`), trick-detail reference-media split (`.reference-media-subsection`, `.reference-media-subsection--tutorials`, `.reference-media-subsection--demos`, `.reference-media-subheading`).
